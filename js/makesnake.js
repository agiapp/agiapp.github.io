var x, y;		//鼠标当前在页面上的位置
var step = 28;	//字符显示间距，为了好看，step=0则字符显示没有间距
var message = "永远爱着宝贝丫头！";	//跟随鼠标要显示的字符串
...
function handlerMM(e) { //从事件得到鼠标光标在页面上的位置
	e = e || window.event;
	x = (document.layers) ? e.pageX : document.body.scrollLeft + e.clientX - 0;
	y = (document.layers) ? e.pageY : document.body.scrollTop + e.clientY - 0;
}
